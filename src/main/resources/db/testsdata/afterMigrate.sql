...
INSERT INTO pedido (id, subtotal, taxa_frete, valor_total, data_criacao, data_confirmacao, data_cancelamento, data_entrega, restaurante_id, forma_pagamento_id, status, cidade_id, cep, logradouro, numero, complemento, bairro, usuario_cliente_id)
VALUES (1, 0, 5.0, 0, utc_timestamp, null, null, null, 1, 1, 'CRIADO', 1, 'cep1', 'logradouro1', 'numero1', 'complemento1', 'bairro1', 1);
INSERT INTO pedido (id, subtotal, taxa_frete, valor_total, data_criacao, data_confirmacao, data_cancelamento, data_entrega, restaurante_id, forma_pagamento_id, status, cidade_id, cep, logradouro, numero, complemento, bairro, usuario_cliente_id)
VALUES (2, 0, 5.0, 0, utc_timestamp, null, null, null, 2, 2, 'CRIADO', 2, 'cep2', 'logradouro2', 'numero2', 'complemento2', 'bairro2', 2);
