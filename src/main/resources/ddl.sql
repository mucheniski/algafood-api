...
create table restaurante_forma_pagamento (rastaurante_id bigint not null, forma_pagamento_id bigint not null) engine=InnoDB
...
alter table restaurante_forma_pagamento add constraint FKjqgyhck94uji4gyurw0yijovk foreign key (rastaurante_id) references restaurante (id)
